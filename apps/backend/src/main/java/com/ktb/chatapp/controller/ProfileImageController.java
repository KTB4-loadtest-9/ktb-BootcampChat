...
/**
 * 로컬 저장 모드의 프로필 이미지 fallback. 보안 설정에서 인증된 요청만 허용한다.
 *
 */
@Tag(name = "파일 (Files)", description = "인증된 프로필 이미지 서빙")
...
public class ProfileImageController {
    ...
    @Operation(summary = "프로필 이미지 조회", description = "프로필 이미지를 반환합니다. 인증이 필요합니다.")
    @ApiResponses({
